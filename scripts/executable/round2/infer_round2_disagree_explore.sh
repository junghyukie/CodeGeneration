...
#   OUTPUT_DIR          - where round-2 results are saved   (default: ./inference_results/round2_disagree_explore/step_8)
...
: "${OUTPUT_DIR:=./inference_results/round2_disagree_explore/step_8}"
