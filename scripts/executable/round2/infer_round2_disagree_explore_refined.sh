...
# using locally stored refined adapters (Step 3a adapter refinement).
#
# Identical to infer_round2_disagree_explore.sh except BASE_PATH points to
# a local refined_adapters/ directory instead of the original HF Hub repo.
#
...
#   BASE_PATH           - local refined adapter dir         (default: ./refined_adapters)
...
#   OUTPUT_DIR          - where round-2 results are saved   (default: ./inference_results/round2_disagree_explore_refined/step_8)
...
#
# Usage:
#   bash scripts/round2/infer_round2_disagree_explore_refined.sh
...
: "${OUTPUT_DIR:=./inference_results/round2_disagree_explore_refined/step_8}"
...
echo "[round2_disagree_explore_refined] ============================================"
echo "[round2_disagree_explore_refined] Model          : $MODEL"
echo "[round2_disagree_explore_refined] Base adapter   : $BASE_PATH (local refined)"
echo "[round2_disagree_explore_refined] Router         : $ROUTER_PATH"
echo "[round2_disagree_explore_refined] Prev results   : $PREV_RESULTS_DIR ($PREV_RESULTS_SOURCE)"
echo "[round2_disagree_explore_refined] TB router      : $TB_ROUTER_PATH"
echo "[round2_disagree_explore_refined] Output dir     : $OUTPUT_DIR"
echo "[round2_disagree_explore_refined] Tasks          : $TASKS"
echo "[round2_disagree_explore_refined] ============================================"
...
echo "[round2_disagree_explore_refined] Done. Results saved to $OUTPUT_DIR"

HF_REPO="ankhanhtran02/$(basename "$(dirname "$OUTPUT_DIR")")"
echo "[round2_disagree_explore_refined] Uploading $OUTPUT_DIR → $HF_REPO"
