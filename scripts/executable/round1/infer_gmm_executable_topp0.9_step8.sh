#!/usr/bin/env bash
# Round-1 GMM-router inference: step 8.
# Infers all tasks seen through step 8: python,cpp,swift,rust,csharp,java,php,typescript,shell
#
# Usage:
#   bash scripts/executable/round1/infer_gmm_executable_topp0.9_step8.sh [soft|hard]
#
...
python infer_gmm.py \
  ...
  --seed                 42 \
  --inference_output_path ./inference_results/gmm_exe_vf0.02_dim256_comp4_omega1.0_"${ROUTING_MODE}_temp_1.0_routing_topp0.9/step_8"
